 ...
 */
public class EnvironmentPreferencesFieldEditor extends FieldEditor {
	private static final String DEFAULT_ADD_LABEL = "Add";
	private static final String DEFAULT_REMOVE_LABEL = "Remove";
	private static final String DEFAULT_SEPERATOR = PreferenceConstants.P_ENVIRONMENTS_SPLITTER;

	private static final int VERTICAL_DIALOG_UNITS_PER_CHAR = 8;
	private static final int HORIZONTAL_DIALOG_UNITS_PER_CHAR = 4;
	private static final int LIST_HEIGHT_IN_CHARS = 5;
	...
	public EnvironmentPreferencesFieldEditor(String name, String labelText, Composite parent) {
		super(name, labelText, parent);
	}

	public EnvironmentPreferencesFieldEditor(String name, String labelText, String addButtonText, String removeButtonText,
			Composite parent) {
		super(name, labelText, parent);
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		remove.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				if(!list.getSelection().equals("eclipse")) {
	...
	/**
	 * Sets the label for the button that adds the contents of the text field to
	 * the list.
	 */
	...
	/**
	 * Sets the label for the button that removes the selected item from the
	 * list.
	 */
	...
	/**
	 * Sets the string that seperates items in the list when the list is stored
	 * as a single String in the preference store.
	 */
	...
	private void selectionChanged() {
		...
		remove.setEnabled(index >= 0 && !list.getItem(index).equals("eclipse"));
		if(list.getItem(index).equals("eclipse")) {
			remove.setToolTipText("Cannot remove eclipse");
		} else {
